...
const TimeUnit = ({ value, label }: TimeUnitProps) => (
  <div className="flex flex-col items-center">
    <div className="text-background rounded-lg px-4 py-3 min-w-15 text-center font-medium font-mono text-6xl">
      {String(value).padStart(2, "0")}
    </div>
    <span className="text-sm mt-1 text-background">{label}</span>
  </div>
);
